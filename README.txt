...
WHAT I DID:
Everything inside the Server folder was made by me using Visual Studio.  The simple server connects to the client and saves a game state, applying all the rules and logic of the game.
